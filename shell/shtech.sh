...
num=$#
if [ "$num" = "2" ]; then
       result=` curl -H "Content-Type: application/x-www-form-urlencoded" -X POST -s --data "userName=$1&password=$2&hasValidateCode=false&authLan=zh_CN"  --cookie "JSESSIONID=D56359E00B58C7877668AAB44B3BFE31"  https://controller1.net.shanghaitech.edu.cn:8445/PortalServer//Webauth/webAuthAction\!login.action`
